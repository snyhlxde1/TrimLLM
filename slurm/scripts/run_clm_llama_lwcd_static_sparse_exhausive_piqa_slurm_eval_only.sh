...
export SLURM_JOB_NODELIST=p4-r66-b.g42cloud.net
...
srun run_clm_llama_lwcd_static_sparse_exhausive_eval_only.sh piqa decapoda-research/llama-7b-hf 2 0.625 4