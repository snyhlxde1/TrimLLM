#!/bin/bash
#SBATCH --job-name=sapling_llama_7b_arc_easy_exhausive # create a short name for your job
#SBATCH --nodes=1
...
#SBATCH --error=/nfs/projects/mbzuai/ext_hao.zhang/lanxiang/Sapling/slurm/logs/sbatch/%J.%N.exhausive_arc_easy.err
#SBATCH --output=/nfs/projects/mbzuai/ext_hao.zhang/lanxiang/Sapling/slurm/logs/sbatch/%J.%N.exhausive_arc_easy.out

export SLURM_JOB_NODELIST=p3-r46-a.g42cloud.net
...
srun run_clm_llama_lwcd_static_sparse_exhausive.sh arc_easy decapoda-research/llama-7b-hf 2 0.625 1