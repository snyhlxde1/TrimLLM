...
torchrun --nproc_per_node=16 \
    ...
    --output_dir ../../outputs/$MODEL/${TASK}_bs_${bs}/layerwise_condense_sparse_exhausive_sr${sr}_trial_${trial}_max_fro 2>&1 | tee ../logs/train/llama_7b_layerwise_condense_sparse_exhausive_${TASK}_bs_${bs}_sr${sr}_trial_${trial}_max_fro.log